...
def run(spark: SparkSession, config: dict) -> None:
    ...
    try:
        ...
        new_rows = well_being_dataset.join(existing_ids, ID_COLS, "left_anti")
        ...
        well_being_dataset.write.mode("overwrite").parquet(output_dataset_path)
        logging.info("Initial dataset created successfully")


if __name__ == "__main__":
    spark = (
        SparkSession.builder.appName("Well-being Extract")
        .enableHiveSupport()
        .getOrCreate()
    )
